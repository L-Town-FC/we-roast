...
const ignoreList = ["ContentType", "bodyTextNode", "BodyTextNode", "Asset"]

const getContentTypeMapping = async (
    entityNodes,
...
module.exports = {
    setFieldsOnGraphQLNodeType: async function(
        data,
        { spaceId, accessToken, host }
    ) {
        ...
        const getContentTypeForEntry = await getContentTypeMapping(
            entityNodes,
            { spaceId, accessToken, host }
        )
